...
TABLE_ROWS = [
    ...
    ("leq_dbfs", "Leq (dBFS)"),
    ("laeq_dbfs", "LAeq (dBFS)"),
    ("laeq_trim5_dbfs", "LAeq, loudest 5 % trimmed (dBFS)"),
    ...
    ("tonal_prominence_db", "Tonal prominence ΔL, strongest tone (dB)"),
    ("tonal_prominence_hz", "Strongest persistent tone (Hz)"),
    ("n_prominent_tones", "Persistent prominent tones (count)"),
    ("fluctuation_index", "Fluctuation index (4 Hz-weighted)"),
...
STATE_ROWS = [
    ...
    ("leq_dbfs", "Leq (dBFS)"),
    ("laeq_dbfs", "LAeq (dBFS)"),
    ("laeq_trim5_dbfs", "LAeq, trimmed (dBFS)"),
    ("L90", "L90 (dBFS)"),
    ("dynamics_L10_L90", "Dynamics L10−L90 (dB)"),
    ("events_per_min", "Events (per min)"),
    ("intermittency_ratio_pct", "Intermittency ratio IR (%)"),
    ("tonal_prominence_db", "Tonal prominence ΔL (dB)"),
    ("diffuseness_median", "Diffuseness ψ, median"),
